...
uses
  ...
  IBCustomDataSet, IBDatabase, DB, RxMemDS, RepOpenOrdersDModule;

type
  Tdm_RepClosedOrders = class(Tdm_RepOpenOrders)
...
{var
  dm_RepClosedOrders: Tdm_RepClosedOrders;
 }
implementation
...
function Tdm_RepClosedOrders.FillResultDset: boolean;
var
  i: integer;
...
function Tdm_RepClosedOrders.GetWorks(OrderID: integer): string;
var _res: string;
begin
  Result:='';
...
procedure Tdm_RepClosedOrders.Init;
begin
  SetSqlString;
  SetRecordCount;
end;

function Tdm_RepClosedOrders.PrepareDset: boolean;
begin
  Result:=false;
...
procedure Tdm_RepClosedOrders.SetRecordCount;
begin
...
procedure Tdm_RepClosedOrders.SetSqlString;
var

inherited frm_Disconnection: Tfrm_Disconnection
  Left = 335
  Top = 263
  Width = 719
  Height = 488
  ...
  object pnl_Top: TPanel
    ...
    object mem_Disconnections: TMemo
      ...
      Lines.Strings = (
        'Memo1')
      TabOrder = 0
      OnChange = mem_DisconnectionsChange
  ...
  object pnl_Grid: TPanel
    ...
    BevelInner = bvLowered
    TabOrder = 2
    object DBG_DisconnectionsEh: TDBGridEh
      Left = 2
      Top = 2
      Width = 707
      Height = 246
      Align = alClient
      DataSource = ds_Disconnections
      ...
      TitleFont.Style = []
      UseMultiTitle = True
      OnKeyDown = DBG_DisconnectionsEhKeyDown
      Columns = <
        item
  ...
  object ds_Disconnections: TDataSource
    DataSet = DM_Disconnect.ds_Disconnections
    OnStateChange = ds_DisconnectionsStateChange
    Left = 312
    Top = 224
  end
end

inherited frame_MaterGrid_vds: Tframe_MaterGrid_vds
  Width = 540
  ...
  inherited dset_Main: TIBDataSet
    ...
    DeleteSQL.Strings = (
      'delete from DEPARTUREMATERIALS_vds where id=:old_id')
    InsertSQL.Strings = (
    ...
    ModifySQL.Strings = (
      'update DEPARTUREMATERIALS_vds set'

inherited dm_RepDiscon_vds: Tdm_RepDiscon_vds
  Left = 523
  Top = 406
  Height = 359
  Width = 391
  ...
  object ResultDset: TRxMemoryData
    ...
    object ResultDsetG_KV: TIntegerField
      FieldName = 'G_KV'
    end
    object ResultDsetG_ZHD: TIntegerField
      FieldName = 'G_ZHD'
    end
    object ResultDsetG_STOJ: TIntegerField
      FieldName = 'G_STOJ'
    end

...
type
  Tfrm_OptRegSingle_vds = class(Tfrm_BaseOption)
    Bevel1: TBevel;
    Label1: TLabel;
    de_beg: TDateEdit;
    Label2: TLabel;
...
var
  frm_OptRegSingle_vds: Tfrm_OptRegSingle_vds;
...
constructor Tfrm_OptRegSingle_vds.Create(AOwner: TComponent; ATitle: string);
begin
...
procedure Tfrm_OptRegSingle_vds.InitList;
var
  SQL: string;
begin
   F_RegID := 0;
...
procedure Tfrm_OptRegSingle_vds.btn_okClick(Sender: TObject);
begin
  inherited;
...
procedure Tfrm_OptRegSingle_vds.btn_exitClick(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure Tfrm_OptRegSingle_vds.FormCreate(Sender: TObject);
begin
  inherited;
  InitList;
end;

...
type
  Tfrm_OptRepDiscon_vds = class(Tfrm_BaseOption)
    de_beg: TDateEdit;
    de_End: TDateEdit;
    Label1: TLabel;
    Label2: TLabel;
...
constructor Tfrm_OptRepDiscon_vds.Create(AOwner: TComponent; ATitle: string);
begin
  inherited Create(AOwner);
  Caption:=ATitle;
end;

procedure Tfrm_OptRepDiscon_vds.btn_okClick(Sender: TObject);
begin
  inherited;
...
procedure Tfrm_OptRepDiscon_vds.btn_exitClick(Sender: TObject);
begin
  inherited;
Close;
end;

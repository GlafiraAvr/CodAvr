...
type
  Tdm_ActExeWorks = class(Tdm_NGReportBase)
...
function Tdm_ActExeWorks.FillResultDset: boolean;
var
  i: integer;
begin
  ResultDset.Close;
...
function Tdm_ActExeWorks.GetWorks(OrderID: integer): string;
begin
  Result:='';
...
procedure Tdm_ActExeWorks.Init;
begin
  SetSqlString;
  SetRecordCount;
end;

function Tdm_ActExeWorks.PrepareDset: boolean;
begin
  Result:=false;

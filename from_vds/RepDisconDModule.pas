...
type
  Tdm_RepDiscon = class(Tdm_NGReportBase)
...
function Tdm_RepDiscon.FillResultDset: boolean;
var
  i, diff: integer;
begin
  //ResultDset.Close;
...
function Tdm_RepDiscon.GetWorks(OrderID: integer): string;
var _res: string;
begin
  Result:='';
...
function Tdm_RepDiscon.GetTimeDiff(OrderID: integer): integer;
var
...
procedure Tdm_RepDiscon.Init;
begin
  SetSqlString;
  SetRecordCount;
end;

function Tdm_RepDiscon.PrepareDset: boolean;
begin
  Result:=false;
